      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        {portfolioData.experiences.map((experience, index) => (
          ...
          >
            ...
            <div className="glass-effect p-6 rounded-xl hover:shadow-lg hover:shadow-purple-900/10 transition-all duration-300">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {experience.skills.map((skill, skillIndex) => (
                      <span key={skillIndex} className="px-3 py-1 text-sm rounded-full bg-gray-800/70 text-gray-300">
                        {skill}
                      </span>
                    ))}
                  </div>
