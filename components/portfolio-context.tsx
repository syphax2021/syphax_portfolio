...
const defaultPortfolioData: PortfolioData = {
  ...
  photo: "/logofavicon.png?height=400&width=300",
  birthDate: "30 Juin 2001",
  location: "Montreiul",
  phone: "06 36 02 16 23",
  ...
  experiences: [
    {
      ...
      missions: [
        ...
        "Configuration de pare-feu",
        "Gestion des droits d'accès",
        "Amélioration des applications web pour prendre des rendez-vous",
      ],
      projects: ["Système de sécurité informatique", "Application de rendez-vous"],
